...
5. **Throughput is not the constraint.** 4.4 µs per unit-tick in release —
   200 units at 30 ticks/s is ~2.6% of one core. The tick rate (Q6) is not
   bounded by interpretation cost at any fleet size currently contemplated.
