# A starter red bot: haul ore from the nearest deposit to the nearest place
# that takes it, and build where the plans say. Place a building plan with
# the mark tool in the game; the bots will fill and build it.
